...
const skillCategories = [
  {
    ...
    skills: [
      { name: "React", Icon: ReactIcon, years: "3+" },
      { name: "Next.js", Icon: NextJsIcon, years: "2.5+" },
      { name: "TypeScript", Icon: TypeScriptIcon, years: "3+" },
      { name: "JavaScript", Icon: JavaScriptIcon, years: "3+" },
      { name: "Tailwind", Icon: TailwindIcon, years: "2.5+" },
      { name: "Redux", Icon: ReduxIcon, years: "2+" },
      { name: "Zustand", Icon: ZustandIcon, years: "2+" },
      { name: "shadcn/ui", Icon: ShadcnIcon, years: "1.5+" },
    ],
  },
  {
    id: "backend",
    ...
    skills: [
      { name: "Node.js", Icon: NodeJsIcon, years: "3+" },
      { name: "NestJS", Icon: NestJsIcon, years: "2+" },
      { name: "REST APIs", Icon: RestApiIcon, years: "3+" },
      { name: "GraphQL", Icon: GraphQLIcon, years: "2+" },
      { name: "MongoDB", Icon: MongoDBIcon, years: "2+" },
      { name: "PostgreSQL", Icon: PostgreSQLIcon, years: "2+" },
      { name: "Prisma", Icon: PrismaIcon, years: "2+" },
      { name: "Supabase", Icon: SupabaseIcon, years: "1.5+" },
      { name: "Firebase", Icon: FirebaseIcon, years: "1.5+" },
      { name: "n8n", Icon: N8nIcon, years: "1.5+" },
      { name: "Python", Icon: PythonIcon, years: "1.5+" },
    ],
  },
  {
    id: "ai",
    ...
    hideYears: true,
    skills: [
      { name: "Claude API", Icon: ClaudeIcon, years: "" },
      { name: "OpenAI API", Icon: ChatGPTIcon, years: "" },
      { name: "Agentic Systems", Icon: AgentIcon, years: "" },
      { name: "LLM APIs", Icon: SparkleIcon, years: "" },
      { name: "LangChain", Icon: LangChainIcon, years: "" },
      { name: "RAG / Vector DBs", Icon: VectorDBIcon, years: "" },
      { name: "n8n", Icon: N8nIcon, years: "" },
      { name: "Python", Icon: PythonIcon, years: "" },
    ],
  },
  {
    id: "blockchain",
  ...
  },
  {
    ...
    lightColor: "bg-playful-yellow/20",
    borderColor: "border-playful-yellow",
    textColor: "text-playful-yellow",
    hideYears: true,
    skills: [
